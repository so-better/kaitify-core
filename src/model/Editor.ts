...
import { formatInlineParseText, formatBlockInChildren, formatSiblingNodesMerge, formatPlaceholderMerge, formatZeroWidthTextMerge, RuleFunctionType, formatParentNodeMerge, formatUneditableNoodes } from './config/format-rules'
...
import { Extension, HistoryExtension, ImageExtension, TextExtension, BoldExtension, ItalicExtension, StrikethroughExtension, UnderlineExtension, SuperscriptExtension, SubscriptExtension, CodeExtension, FontSizeExtension, VideoExtension, ColorExtension, BackColorExtension, LinkExtension } from '../extensions'
...
export class Editor {
	 ...
	 * 插件数组【初始化后不可修改】
	 */
	extensions: Extension[] = [ImageExtension, VideoExtension, TextExtension, HistoryExtension, BoldExtension, ItalicExtension, StrikethroughExtension, UnderlineExtension, SuperscriptExtension, SubscriptExtension, CodeExtension, FontSizeExtension, FontFamilyExtension, ColorExtension, BackColorExtension, LinkExtension]
	/**
	 * 编辑器的节点数组格式化规则【初始化后不可修改】
	 */
	formatRules: RuleFunctionType[] = [formatBlockInChildren, formatInlineParseText, formatUneditableNoodes, formatPlaceholderMerge, formatZeroWidthTextMerge, formatSiblingNodesMerge, formatParentNodeMerge]
	/**
