...
const _AlexElement = class _AlexElement {
  ...
  static create(elementConfig) {
    ...
    if (elementConfig.type == "text") {
      el = new _AlexElement(elementConfig.type, null, elementConfig.marks, elementConfig.styles, elementConfig.textcontent);
    } else {
      el = new _AlexElement(elementConfig.type, elementConfig.parsedom, elementConfig.marks, elementConfig.styles, null);
