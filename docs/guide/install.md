...
- 下载地址：[kaitify](https://registry.npmmirror.com/@kaitify/core/download/@kaitify/core-0.0.1-beta.13.tgz)
...
```html
<!-- 引入固定版本的kaitify -->
<script src="https://unpkg.com/@kaitify/core@0.0.1-beta.13/lib/kaitify-core.umd.js"></script>
<!-- 始终引入最新的kaitify -->
...
# 安装指定版本
npm install @kaitify/core@0.0.1-beta.13
```
...
# 安装指定版本
yarn install @kaitify/core@0.0.1-beta.13
```
...
# 安装指定版本
pnpm install @kaitify/core@0.0.1-beta.13
```
