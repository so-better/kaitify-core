...
export default {
	data() {
		return {
			value: '<ol><li>十年生<b><span>死两茫茫</span><span>死两茫茫</span></b>，不思量，自难忘。</li><li>千里孤坟，<span style="font-weight:bold;color:#798af1">无处话凄凉</span>。</li><li>纵使相逢应不识，尘满面，鬓如霜。<span style="text-decoration-line:underline"><img src="https://www.mvi-web.cn/mvi-resources/images/mvi_image_0_1676971974565.png" style="width:100px" /></span></li></ol>',
			editor: null
		}
	},
	mounted() {
