...
| pasteText       | 粘贴纯文本内容时触发，回调参数为粘贴的内容                                                                                                        |
| pasteHtml       | 粘贴 html 内容时触发，回调参数为粘贴的内容和内容转换后的 AlexEelemnt 数组                                                                         |
...
| afterRender     | 当执行 domRender 触发 dom 渲染后触发的事件                                                                                                        |
| beforeRender    | 当执行 domRender 触发 dom 渲染之触发的事件                                                                                                        |
